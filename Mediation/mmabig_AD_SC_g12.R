...
write.table(data.frame(colnames(frmsig1)), 'med_list1SC_g12.csv', append=T, sep=',')
write.table(data.frame(frmsig1), 'SC1_g12.csv', append=T, sep=',')

save.image("./workspace_SC_g12.RData")
