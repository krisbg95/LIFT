...
write.table(data.frame(colnames(frmsig3)), 'med_list3rsFC_g32.csv', append=T, sep=',')
write.table(data.frame(frmsig3), 'rsFC1_g32.csv', append=T, sep=',')

save.image("./workspace_rsFC_g32.RData")
